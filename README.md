...
•	State Management: It uses st.session_state to store conversation history temporarily in the computer’s RAM, allowing the bot to
...
3.	API Request: Python sends this prompt to the Google Gemini 1.5 Flash model.
  
5.	AI Response: The model processes the query and sends back a response.
  
7.	Instant Display: Streamlit renders the response in a chat-bubble format for the user.
